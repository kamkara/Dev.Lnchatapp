class ExercisesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @exercise.save
        format.html { redirect_to course_url(@course), notice: "Exercise was successfully created." }
  ...
  private
    ...
    def exercise_params
      params.require(:exercise).permit(:title, :content, :correct_content, :slug, :user_id, :course_id, :edition)
    end
end
