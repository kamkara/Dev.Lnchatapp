...
class AnwsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create anwser" do
    assert_difference("Anwser.count") do
      post anwsers_url, params: { anwser: { content: @anwser.content, question_id: @anwser.question_id, user_id: @anwser.user_id } }
    end
  ...
  test "should update anwser" do
    patch anwser_url(@anwser), params: { anwser: { content: @anwser.content, question_id: @anwser.question_id, user_id: @anwser.user_id } }
