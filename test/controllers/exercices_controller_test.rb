...
class ExercicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exercice" do
    assert_difference("Exercice.count") do
      post exercices_url, params: { exercice: { course_id: @exercice.course_id, name: @exercice.name, slug: @exercice.slug, user_id: @exercice.user_id } }
    end
  ...
  test "should update exercice" do
    patch exercice_url(@exercice), params: { exercice: { course_id: @exercice.course_id, name: @exercice.name, slug: @exercice.slug, user_id: @exercice.user_id } }
